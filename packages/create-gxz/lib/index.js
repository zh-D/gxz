...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var program, dirname, options, templateName;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                templateName = options.template ? options.template : program.args[1];
                console.log('create-dzh version:', pkgContent.version);
                console.log('create-dzh args', dirname, templateName);
                return [4 /*yield*/, create_1.default(dirname, templateName)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
